...
$navItems = [
    ...
    'articles' => ['icon' => 'fa-file-text', 'label' => '文章管理', 'url' => 'articles.php'],
    'projects' => ['icon' => 'fa-folder-open', 'label' => '项目管理', 'url' => 'projects.php'],
    'moments' => ['icon' => 'fa-bolt', 'label' => '动态管理', 'url' => 'moments.php'],
